# Bezpečnostní hranice AI Studio GHRAB 0.21.58

> Aktuální verze: **0.21.58** · etapa P5

> 0.21.58 přidává fail-closed auto-patch promotion pro jednou GARP 2.5.1 zařazené aplikace. Automatické přijetí vyžaduje živé deployment ověření a nesmí obejít Platform, repository ani ecosystem kontrakty.
