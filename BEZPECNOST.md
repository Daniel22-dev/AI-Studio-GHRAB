...
Ochranný bootstrap je integrován v Generátoru 7.1.17, Diferenciátoru 1.3.36, Hodnotiteli maturitních slohů 1.5.13, LUDUSu 1.16.16, Korespondenčním asistentovi 5.10.9, ACTIVA 0.5.14, SORTIO 1.0.13 a Lesson Hubu 1.2.12. Běžný vstupní bod těchto aplikací nejprve načte centrální modul a ověří podpis, platnost, revokaci, roli, ID aplikace a aktuální verzi školení. Jde o praktickou ochranu proti běžnému sdílení přímé adresy, nikoli o serverovou ochranu zdrojového kódu: technicky zkušený uživatel může veřejný statický kód stáhnout nebo spustit mimo standardní bootstrap. Při nedostupnosti centrální konfigurace robustní bootstrap zobrazí srozumitelnou chybovou obrazovku a aplikaci nespustí.
