...
- Plný správce má v horní navigaci Studia novou záložku AI Akademie, která vede přímo do školicího střediska; učitel ani zástupce správce ji nevidí.
- Adresa Akademie je součástí deployment konfigurace pro GitHub Pages i připravený školní server, takže propojení není závislé na jedné natvrdo zapsané produkční URL.
- Odkaz do Akademie předává pouze adresu Studia pro bezpečný návrat; nepřenáší přístupový token ani jiné tajné údaje.
