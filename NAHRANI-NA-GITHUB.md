# Nahrání AI Studio GHRAB 0.21.80

> Aktuální verze: **0.21.80** · etapa P5

> 0.21.80 opravuje source-candidate gate: Generátor zůstává ručně přijatý na 7.1.28 a repository kandidát 7.1.30 se bez úspěšného deploymentu nepovýší ani nezablokuje release Studia.
