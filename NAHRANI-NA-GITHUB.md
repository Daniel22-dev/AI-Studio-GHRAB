# Nahrání AI Studio GHRAB 0.20.2
...
> Verze 0.20.2 opravuje falešný pád release gate po úspěšné živé synchronizaci KS 5.9.1. Ochrana neměnných Core souborů z verze 0.20.1 zůstává zachována.
...
Správcovská stránka po živé synchronizaci zobrazí aktivní Core 1.0.0 a KS 5.9.1 jako **Nasazeno**. Pokud živý manifest dočasně není dostupný, Studio použije bezpečný přechodový nebo fallback stav a nebude nasazení falešně deklarovat.
