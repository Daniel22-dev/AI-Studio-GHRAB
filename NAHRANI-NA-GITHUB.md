# Nahrání AI Studio GHRAB 0.20.4
...
> Verze 0.20.4 opravuje falešný pád release gate po úspěšné živé synchronizaci KS 5.9.3. Ochrana neměnných Core souborů z verze 0.20.1 zůstává zachována.
...
Správcovská stránka po živé synchronizaci zobrazí aktivní Core 1.0.0 a KS 5.9.3 jako **Nasazeno**. Pokud živý manifest dočasně není dostupný, Studio použije bezpečný přechodový nebo fallback stav a nebude nasazení falešně deklarovat.
