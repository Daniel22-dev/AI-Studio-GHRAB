# Přesný postup nahrání AI Studio GHRAB 0.21.56 na GitHub – až po schválení
...
1. Stáhněte a rozbalte `AI-Studio-GHRAB-0.21.56-AI-AKADEMIE.zip`.
2. Do kořene repozitáře `AI-Studio-GHRAB` nahrajte přímo všechny soubory a složky z rozbaleného archivu.
3. Commit pojmenujte například `AI Studio 0.21.56 – propojení s AI Akademií`.
...
- `dist/build-info.json`, PWA manifest a service worker musí uvádět 0.21.56.
