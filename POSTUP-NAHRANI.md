# Přesný postup nahrání AI Studio GHRAB 0.21.57 na GitHub – až po schválení

> Aktuální verze: **0.21.57** · etapa P5

> 0.21.57 zavádí řízené auto-patch promotion release wave pro GARP 2.5.1 zařazené aplikace; ostatní aplikace zůstávají v manuálním režimu.
...
1. Stáhněte a rozbalte `AI-Studio-GHRAB-0.21.57-RELEASE-WAVE-AUTO-PATCH.zip`.
2. Do kořene repozitáře `AI-Studio-GHRAB` nahrajte přímo všechny soubory a složky z rozbaleného archivu.
3. Commit pojmenujte například `AI Studio 0.21.57 – řízené release-wave auto-patch promotion`.
...
- `dist/build-info.json`, PWA manifest a service worker musí uvádět 0.21.57.
