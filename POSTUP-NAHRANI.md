# Přesný postup nahrání AI Studio GHRAB 0.20.1 na GitHub
...
3. Potom nahrajte obsah balíku AI Studio GHRAB 0.20.1 do kořene repozitáře `AI-Studio-GHRAB`.
...
V patičce Studia a v `dist/build-info.json` musí být verze **0.20.1**.

## Pořadí pro Core

1. Nasaďte AI Studio 0.20.1.
