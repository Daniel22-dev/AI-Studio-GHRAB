# Přesný postup nahrání AI Studio GHRAB 0.21.7 na GitHub
...
1. Stáhněte a rozbalte `AI-Studio-GHRAB-v0.21.7-GitHub.zip`.
2. Do kořene repozitáře `AI-Studio-GHRAB` nahrajte přímo všechny soubory a složky z rozbaleného archivu.
3. Commit pojmenujte například `AI Studio 0.21.7 – provozní doladění Studia`.
...
- `dist/build-info.json`, PWA manifest a service worker musí uvádět 0.21.7.
