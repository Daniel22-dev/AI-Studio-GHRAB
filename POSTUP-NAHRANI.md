# Přesný postup nahrání AI Studio GHRAB 0.18.8 na GitHub
...
1. Nejprve nasaďte aktuální chráněné verze dílčích aplikací:
   ...
   - Korespondenční asistent 5.5.1,
   - LUDUS 1.16.3.
2. Potom nahrajte obsah balíku AI Studio GHRAB 0.18.8 do kořene repozitáře `AI-Studio-GHRAB`.
...
V patičce Studia a v `dist/build-info.json` musí být verze **0.18.8**.
