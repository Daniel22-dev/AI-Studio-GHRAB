# Přesný postup nahrání AI Studio GHRAB 0.16.5 na GitHub
...
1. Nejprve nasaďte aktuální chráněné verze dílčích aplikací:
   ...
   - LUDUS 1.15.0.
2. Potom nahrajte obsah balíku AI Studio GHRAB 0.16.5 do kořene repozitáře `AI-Studio-GHRAB`.
...
V patičce Studia a v `dist/build-info.json` musí být verze **0.16.5**.
