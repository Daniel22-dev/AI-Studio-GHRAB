...
**Verze 0.16.0 – federovaný serverless portál pěti chráněných školních aplikací s filmovou desktopovou bránou, režimem projekce, řízeným přístupem, pilotním měřením a diagnostickým hlášením chyb.**
...
## Hlavní novinky 0.16.0

- Domovská obrazovka na PC používá prostorovou scénu s lehkými holografickými panely, paralaxou a centrální hvězdnou bránou.
- Spuštění aplikace má výraznou celoplošnou filmovou sekvenci: zaměření cíle, uzamčení prstenců, otevření horizontu událostí a přechod do aplikace.
- Prezentační stránka nabízí samostatný režim projekce na celou obrazovku pro projektor nebo velký displej.
- Poznámky řečníka lze otevřít v odděleném okně na vlastním monitoru; publikum je na projekci nevidí.
- Náročnější vizuální efekty jsou omezeny na domovskou bránu a prezentaci. Správa, evidence, formuláře a pracovní stránky zůstávají bez zbytečných 3D animací.
- Plný, úsporný a vypnutý režim pohybu zůstává zachován.

## Provozní novinky 0.10.0
...
5. AI Studio GHRAB 0.16.0 jako poslední.
