...
**Verze 0.18.8 – federovaný serverless portál sedmi chráněných školních aplikací s aktuálním registrem a manuálem Korespondenčního asistenta 5.5.1.**
...
## Hlavní novinky 0.18.8

- Korespondenční asistent je v živém i záložním registru veden ve verzi 5.5.1,
...
- Diferenciátor 1.3.3 a Korespondenční asistent 5.5.1 se načítají z vlastních repozitářů a samostatných adres GitHub Pages,
