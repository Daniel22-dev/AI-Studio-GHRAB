...
**Aktuální verze:** 0.21.80

0.21.80 odděluje schválený release-wave baseline od novějšího repository-only kandidáta. Kandidát se eviduje, ale bez deployment evidence nebo explicitního ručního reconciliation nepřepisuje runtime registry.
