# Release checklist AI Studio GHRAB 0.18.10

**Aktuální verze: 0.18.10**

## Veřejný balík

- [x] Verze 0.18.10 je shodná v package, buildu, dokumentaci a changelogu; PWA manifest nepoužívá nestandardní pole `version`.
...
- [ ] V anonymním okně potvrdit sedm viditelných a uzamčených aplikací (čtyři v Top 4 a tři v katalogu).
...
- [ ] Katalog zobrazuje všech sedm karet i bez přístupu.
