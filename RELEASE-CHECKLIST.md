# Release checklist AI Studio GHRAB 0.21.58

> Aktuální verze: **0.21.58** · etapa P5

> 0.21.58 přidává řízené auto-patch promotion release wave pro GARP 2.5.1 zařazené aplikace; default zůstává manual a pouze živý deployment může být auto-promoted.
...
- [x] Verze 0.21.58 je shodná v package, PWA manifestu, QA manifestu, buildu, dokumentaci a changelogu.
...
- [x] Všechny lokální JS/CSS vstupy a relativní modulové importy mají ve výsledném buildu revizi `?v=0.21.58`.
