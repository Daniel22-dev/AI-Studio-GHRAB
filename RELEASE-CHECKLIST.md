# Release checklist AI Studio GHRAB 0.18.9

**Aktuální verze: 0.18.9**

## Veřejný balík

- [x] Verze 0.18.9 je shodná v package, buildu, dokumentaci a changelogu; PWA manifest nepoužívá nestandardní pole `version`.
