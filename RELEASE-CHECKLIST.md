# Release checklist AI Studio GHRAB 0.20.4

**Aktuální verze: 0.20.4**

## Veřejný balík

- [x] Verze 0.20.4 je shodná v package, buildu, dokumentaci a changelogu; PWA manifest nepoužívá nestandardní pole `version`.
