# Release checklist AI Studio GHRAB 0.20.17

> Aktuální verze: **0.20.17** · etapa P3

## Veřejný balík

- [x] Verze 0.20.17 je shodná v package, PWA manifestu, QA manifestu, buildu, dokumentaci a changelogu.
...
- [x] Všechny lokální JS/CSS vstupy a relativní modulové importy mají ve výsledném buildu revizi `?v=0.20.17`.
