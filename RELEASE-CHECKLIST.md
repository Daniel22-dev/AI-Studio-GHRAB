# Release checklist AI Studio GHRAB 0.21.41
...
- [x] 0.21.41 rotuje generační značku po `deleteMyData()` i shared-device `endWork()` a fail-closed odmítne plný úspěch při selhání zápisu tombstone.
...
- [ ] 0.21.41 musí projít druhým nezávislým Claude ověřením tohoto nového cyklu, protože obsahuje distribuovanou opravu D-01.
...
- [x] Verze 0.21.41 je shodná v package, PWA manifestu, QA manifestu, buildu, dokumentaci a changelogu.
...
- [x] Všechny lokální JS/CSS vstupy a relativní modulové importy mají ve výsledném buildu revizi `?v=0.21.41`.
