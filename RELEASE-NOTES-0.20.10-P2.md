# AI Studio GHRAB 0.20.10 — etapa P2
...
- Vratná migrace aplikačních dat do prefixu `ghrab.ai-studio.*`; záloha se vytváří před odstraněním starých klíčů.
...
- PWA cache `ghrab-ai-studio-v__APP_VERSION__` a aktualizační zpráva `GHRAB_SKIP_WAITING`.
