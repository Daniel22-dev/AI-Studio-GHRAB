import { BAKED_DEPLOYMENT_CONFIG } from "../config/deployment-baked.js?v=0.21.55";
import { endAccessSession } from "./access-control.js?v=0.21.55";
...
async function startConfiguredLivePresence(appId) {
  ...
  const { startLivePresenceHeartbeat } = await import("../modules/live-presence.js?v=0.21.55");
