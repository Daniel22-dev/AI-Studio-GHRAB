import { BAKED_DEPLOYMENT_CONFIG } from "../config/deployment-baked.js?v=0.21.64";
import { endAccessSession } from "./access-control.js?v=0.21.64";
...
async function startConfiguredLivePresence(appId) {
  ...
  const { startLivePresenceHeartbeat } = await import("../modules/live-presence.js?v=0.21.64");
