...
async function guardAdministratorGuide() {
  ...
  text.textContent = "Pro běžnou práci otevřete manuál učitele. Správcovský manuál navíc popisuje přístupy, náhled zástupce či kolegy, kartový Report, AI Akademii, prezentaci a release workflow.";
