...
document.querySelector('#access-export-pilot')?.addEventListener('click',()=>{G.downloadPilotSummary();G.showToast(G.t('Anonymní souhrn byl stažen. Přiložte jej ke školnímu e-mailu správci pilotu.','The anonymous summary was downloaded. Attach it to a school email to the pilot administrator.'));});
