const CACHE = 'ai-studio-ghrab-v0.12.0';
const CORE = [
  ...
  './assets/brand/brand-mark.svg','./assets/brand/school-logo.png','./assets/brand/portal-core.svg','./assets/brand/portal-gateway.png','./assets/brand/icon-32.png','./assets/brand/icon-48.png','./assets/brand/icon-72.png','./assets/brand/icon-96.png','./assets/brand/icon-128.png','./assets/brand/icon-192.png','./assets/brand/icon-512.png','./assets/brand/icon-maskable-512.png','./assets/brand/apple-touch-icon.png',
  ...
  './automation/index.html','./automation/automation.js','./workflow/index.html','./workflow/workflow.js','./report/index.html','./report/report.js','./bridge/studio-bridge.js','./demo/index.html','./demo/demo.js','./library/index.html','./library/library.js','./library/catalog.json','./manualy/index.html','./manualy/manualy.js','./manualy/manualy.css','./manualy/viewer.html','./manualy/viewer.js','./manualy/viewer.css','./manualy/pilot-report.html','./manualy/pilot-report.js','./manualy/pilot-report.css','./manualy/error-report.html','./manualy/error-report.css',
