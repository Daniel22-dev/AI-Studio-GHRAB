...
Integrace je dokončena v Generátoru 7.1.17, Diferenciátoru 1.3.36, Hodnotiteli maturitních slohů 1.5.13, LUDUSu 1.16.16, Korespondenčním asistentovi 5.10.9, ACTIVA 0.5.14, SORTIO 1.0.13 a Lesson Hubu 1.2.12. Ochrana se nevztahuje jen na karty ve Studiu; probíhá také při přímém otevření každé aplikace.
