# Archiv: release checklist před finálním GARP 2.5.1 cleanupem

> Archivní kopie původního aktivního checklistu před finálním cleanupem 23. 9. 2026. Obsahuje historické GARP 2.3/P2/P3 položky a nemá se používat jako aktuální release gate.

# Release checklist AI Studio GHRAB 0.21.89
