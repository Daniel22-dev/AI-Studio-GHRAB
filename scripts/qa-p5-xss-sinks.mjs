...
const report={schema:'ghrab-p5-xss-sink-audit-v1',appId:baseline.appId,counts,baseline:baseline.counts,csp,evidence,limitations:['This is a regression inventory, not proof that every HTML sink is safe.','CSP compatibility is checked separately; this sink inventory does not prove full CSP coverage.'],failures,status:failures.length?'failed':'passed'};
