...
check(appJs.includes('if (isAdmin() && !isColleaguePreview() && index >= 0 && index < 4)'), "Presun Top 4 neni omezen pouze na skutecny spravcovsky pohled.");
check(appJs.includes('if (isAdmin() && !isColleaguePreview()) {') && appJs.includes('pin-button'), "Hvezdicka Top 4 neni omezena pouze na skutecny spravcovsky pohled.");
