...
const distFiles=await walk(dist);const required=['index.html','styles.css','polish.css','app.js','manifest.webmanifest','sw.js','build-info.json','access/index.html','access/access-control.js','access/app-guard.js','access/error-reporter.js','access/error-reporter.css','tools/access-issuer/index.html','automation/index.html','workflow/index.html','report/index.html','demo/index.html','library/index.html','manualy/index.html','manualy/manualy.js','manualy/manualy.css','manualy/viewer.html','manualy/viewer.js','manualy/viewer.css','manualy/pilot-report.html','manualy/pilot-report.js','manualy/pilot-report.css','manualy/error-report.html','manualy/error-report.css','safety/index.html','pilot/index.html','changelog/index.html','tests/index.html','config/access-policy.json','config/access-public-key.json','config/revoked-access.json','shared/material-validator.js','integration/README.md','integration/generator-access-bootstrap.example.js','integration/essay-evaluator-access-bootstrap.example.js','assets/apps/essay-evaluator-v2.png','assets/brand/school-logo.png','assets/brand/portal-gateway.png'];
