...
if(!registryPageText.includes('Evidence přístupů')||!registryPageText.includes('export-revocations')||!registryScriptText.includes('inspectPermitToken')||!registryScriptText.includes('revoked-access.json'))fail('Správcovská evidence nemá import, přehled nebo export zneplatnění.');
