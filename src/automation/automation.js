...
if(telemetryStatus)telemetryStatus.textContent=mode==="test"?t("Testovací data jsou oddělená a nejsou v měsíčním reportu.","Test data are separated and excluded from the monthly report."):t("Vaše běžné používání vstupuje do místních dat reportu.","Your normal use is included in local report data.");
}
