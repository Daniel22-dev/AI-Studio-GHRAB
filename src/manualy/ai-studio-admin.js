...
async function guardAdministratorGuide() {
  ...
  text.textContent = "Pro běžnou práci otevřete manuál učitele. Správcovský manuál navíc popisuje přístupy, náhled zástupce či kolegy, Report, AI Akademii, prezentaci, vývojářský přehled standardů, průběh diagnostiky a release workflow.";
