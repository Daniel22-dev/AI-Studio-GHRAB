...
document.querySelector("#guide-download").addEventListener("click", () => {
  G.downloadPilotSummary();
  G.showToast(
    G.t(
      "Anonymní souhrn byl stažen. Nyní jej přiložte ke školnímu e-mailu.",
      "The anonymous summary was downloaded. Now attach it to your school email.",
    ),
  );
});
